...
<html lang="en">
  <head>
    ...
    <title>J. Castillon Dental Clinic | Register Page</title>
...
?>
               ...
               <?php } ?> </div>
                ...
                <h4 style="padding-bottom: 20px;text-align: center;color: #28a745;">Register</h4>
                    ...
                    <form method="post" name="signup" onsubmit="return checkpass();">
                       ...
                       <div style="padding-top: 10px;">
                        ...
                        <div class="twice-two" style="padding-top: 30px;">
                          <a class="link--gray" style="color: #28a745;" href="login.php">Already have an account?</a>
                        </div>
