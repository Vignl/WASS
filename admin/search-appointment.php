...
<html>
<head>
<title>J. Castillon Dental Clinic || Search Appointment</title>
...
<body class="cbp-spmenu-push">
	...
	<div class="form-body">
							<form method="post" name="search" action="">
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1" style="padding-bottom: 20px;">Search by Appointment Number / Phone Number / Dental Service / Name</label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control">
...
?>
						 ...
						 <td><a href="view-appointment.php?viewid=<?php echo $row['bid'];?>" class="btn btn-primary">View</a></td> </tr>   <?php 
$cnt=$cnt+1;
} } else { ?>
  <tr>
