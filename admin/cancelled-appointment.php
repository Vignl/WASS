...
<body class="cbp-spmenu-push">
    <div class="main-content">
        <!-- Your existing code for sidebar, header, and content -->
        <div class="main-content">
        ...
        <div id="page-wrapper">
            <div class="main-page">
                <div class="tables">
                    <h3 class="title1">Cancelled Appointments</h3>
                    <div class="table-responsive bs-example widget-shadow">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                $ret = mysqli_query($con, "SELECT tbluser.FirstName,tbluser.LastName,tbluser.Email,tbluser.MobileNumber,tblbook.ID as bid,tblbook.AptNumber,tblbook.ServiceName,tblbook.AptDate,tblbook.AptTime,tblbook.Message,tblbook.BookingDate,tblbook.Status from tblbook join tbluser on tbluser.ID=tblbook.UserID where tblbook.Status='Cancelled'");
                                $cnt = 1;
