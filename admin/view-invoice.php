...
<title>J. Castillon Dental Clinic || View Invoice</title>
...
<th colspan="6">Customer Details</th>	
							 ...
							 <tr> 
								...
								<th>Invoice Date</th> 
								<td colspan="3"><?php echo date('F j, Y', strtotime($row['invoicedate'])); ?></td> 
							</tr> 
<?php }?>
</table> 
<table class="table table-bordered" width="100%" border="1"> 
...
WinPrint.document.write('<img class="logo" src="assets/images/logo.png" alt="Your Logo">');
