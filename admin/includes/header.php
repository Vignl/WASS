...
<div id="logo-container" style="position: absolute; bottom: -43px; left: 230px;">
      ...
      <div class="header-right">
        <div class="profile_details_left"><!--notifications of menu start -->
          <ul class="nofitications-dropdown">
            <?php
$ret1 = mysqli_query($con, "SELECT tbluser.FirstName, tbluser.LastName, tblbook.ID AS bid, tblbook.AptNumber FROM tblbook JOIN tbluser ON tbluser.ID = tblbook.UserID WHERE tblbook.Status = 'Pending'");
...
$ret=mysqli_query($con,"select role, AdminName from tbladmin where ID='$adid'");
