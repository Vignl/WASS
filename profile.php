...
<html lang="en">
  <head>
    ...
    <title>J. Castillon Dental Clinic | Signup Page</title>
...
?>
               ...
               <?php } ?> </div>
                ...
                <?php
                        ...
                        while ($row=mysqli_fetch_array($ret)) {
                ?>
                    <h3 style="padding-bottom: 20px;text-align: center;color: #28a745;">Welcome, <?php echo $row['FirstName'] . ' ' . $row['LastName']; ?></h3><?php } ?>
